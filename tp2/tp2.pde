...
long duracionEstado1 = 5500; 
long duracionEstado2 = 6000; 
long duracionEstado3 = 6000; 
long duracionEstado4 = 6000; 
long duracionEstado5 = 7000; 
long duracionEstado6 = 8000; 
...
void draw() {
  ...
  if (estadoActual == 1) {
    ...
    if (mouseX > botonX && mouseX < botonX + botonAncho && mouseY > botonY && mouseY < botonY + botonAlto) {
        fill(150, 200, 250); // Color del botón al pasar el mouse
    } else {
        fill(100, 150, 200); // Color normal del botón
    }
